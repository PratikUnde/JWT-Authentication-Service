package com.jwt.authenticate.security.services;

import com.jwt.authenticate.models.User; // Import User model
import com.jwt.authenticate.repository.UserRepository; // Import UserRepository for user database operations
